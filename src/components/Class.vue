<template>
	<div>
		<!-- CLASS -->
		<p class="text">Create and edit new classes here<br>that will appear in the top menu bar</p>
		<div v-for="(classGroup, index) in classes" :key="index" class="card" style="margin: 20px;" @click="$emit('viewClass',classGroup)">
					...
					<div class="class-title-col">
						<div class="flex">
							<p class="title is-size-4" style="margin-bottom: 5px;">
								<!-- Year Name -->
								{{classGroup.year_name}}
							</p>
							<b-icon type="is-dark" icon="pencil-alt" @click.native="$emit('editClass', classGroup)"
								class="editIcon">
							</b-icon>
						</div>
